    ...
    def update(self, arg):
        ...
        for offset in range(0, len(data), 128):
            ...
            for i in range(80):
                ...
                print(str(i), hex(a) , hex(b) , hex(c) , hex(d) , hex(e) , hex(f) , hex(g) , hex(h))
            ...
            # print(str(i), hex(h0) , hex(h1) , hex(h2) , hex(h3) , hex(h4) , hex(h5) , hex(h6) , hex(h7))
